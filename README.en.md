...
> **The `v0.2.1` Distribution & PWA candidate is complete and under release freeze:** feature PR [#24](https://github.com/Yoesher/sociology-phd-desk/pull/24) is merged and exact-`main` CI and Pages passed; `release/0.2.1` is limited to release evidence and blocking fixes. The formal `v0.2.1` tag and GitHub Release do not exist yet, so [`v0.2.0`](https://github.com/Yoesher/sociology-phd-desk/releases/tag/v0.2.0) remains the current formal release.
