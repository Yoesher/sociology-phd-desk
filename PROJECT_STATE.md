...
> Status: [`v0.2.2`](https://github.com/Yoesher/sociology-phd-desk/releases/tag/v0.2.2) remains the latest formal Release. The authorized non-map `v0.3.0` work is merged and exact-main verified through `f7dbbcd4c861517beb952a0526d2c4b1982beff4`, including navigation, Zotero/schema v5, Zotero plugin 0.1.0, guarded imports, browser E2E, security automation, and privacy-safe diagnostics/feedback metadata. The 2026-08-15 release-time China map review left all four hard gates BLOCKED and closed Issue #37 as `not planned`; because the frozen scope made the map mandatory, `v0.3.0` is **BLOCKED / NOT RELEASED**. No release branch, tag, or GitHub Release was created.
...
- Navigation PR #38, app-side Zotero/schema-v5 PR #39, Zotero plugin PR #40, Import Guard PR #41, browser-test stability PR #42, browser E2E PR #43, security/dependency automation PR #46, and diagnostics/feedback PR #50 are merged. Current exact main is `f7dbbcd4c861517beb952a0526d2c4b1982beff4`; exact-main CI `31866861053` / job `94969232077`, CodeQL `31866861181` / job `94969232570`, and Pages `31866861000` (build/deploy jobs `94969232037` / `94969359207`, deployment `5917489979`) passed.
