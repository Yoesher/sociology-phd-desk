...
> Status: [`v0.2.2`](https://github.com/Yoesher/sociology-phd-desk/releases/tag/v0.2.2) Simplicity & Motion remains the latest formal Release from exact release SHA `e766d18329ae675d835ce82e02554d5b0d5394ab`. Feature PR [#31](https://github.com/Yoesher/sociology-phd-desk/pull/31) and release PR [#32](https://github.com/Yoesher/sociology-phd-desk/pull/32) passed exact-head CI and P0 = 0 / P1 = 0 self-review before squash merge. Exact-main CI, Pages/deployment, public PWA/static verification, annotated tag, and latest non-draft/non-prerelease UTF-8 Release all passed. The authorized `v0.3.0` cycle has begun with Phase A as a local, uncommitted candidate; no `v0.3.0` release or remote feature result is claimed.
