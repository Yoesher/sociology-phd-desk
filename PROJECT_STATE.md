...
> Status: [`v0.2.2`](https://github.com/Yoesher/sociology-phd-desk/releases/tag/v0.2.2) remains the latest formal Release. The authorized `v0.3.0` cycle is active: navigation, app-side Zotero/schema v5, Zotero plugin 0.1.0, guarded imports, and browser E2E are merged and exact-main verified through `22c68d600fac603e51d3e1f329ef793b8f41d981`. Issue #44 security/dependency automation is a local candidate; Issue #45 diagnostics/feedback/maintainer metadata and Issue #37's release-time map gate remain pending. No `v0.3.0` Release is claimed.
...
- Milestone `v0.3.0` exists. Issues [#34](https://github.com/Yoesher/sociology-phd-desk/issues/34), [#35](https://github.com/Yoesher/sociology-phd-desk/issues/35), [#36](https://github.com/Yoesher/sociology-phd-desk/issues/36), [#5](https://github.com/Yoesher/sociology-phd-desk/issues/5), and [#6](https://github.com/Yoesher/sociology-phd-desk/issues/6) are closed as completed; [#37](https://github.com/Yoesher/sociology-phd-desk/issues/37), [#44](https://github.com/Yoesher/sociology-phd-desk/issues/44), and [#45](https://github.com/Yoesher/sociology-phd-desk/issues/45) track the map gate and the two remaining maintenance slices. Issues #2/#3/#4 remain future backlog.
- Navigation PR #38, app-side Zotero/schema-v5 PR #39, Zotero plugin PR #40, Import Guard PR #41, browser-test stability PR #42, and browser E2E PR #43 are merged. Their current exact-main chain ends at `22c68d600fac603e51d3e1f329ef793b8f41d981`; CI run `31813857736`, Pages run `31813857707`, jobs `94810688870` / `94810689147` / `94811085831`, and deployment `5908697382` all completed successfully on that SHA.
...
- Issue #44 local candidate moves CI and Pages to the current official Node 24-backed action majors (`checkout@v7`, `setup-node@v7`, `upload-artifact@v7`, `configure-pages@v6`, `upload-pages-artifact@v5`, and `deploy-pages@v5`), adds bounded weekly npm/GitHub-Actions Dependabot checks, official CodeQL v4 JavaScript/TypeScript analysis, and an official-registry high/critical npm audit gate. Local verification passed: clean install, 0 npm vulnerabilities, lint, typecheck, 36 files / 322 tests, Zotero plugin 8/8, 1,976-module PWA build, and static-only precache verification. PR/CI/self-review/merge/exact-main/Pages remain pending and are not inferred.
