...
Sociology PhD Desk Zotero 插件 `0.1.0` 正式面向 Zotero 8。Zotero 继续负责文献收藏、PDF、笔记、标注和引用；工作站只接收用户明确选中文献的书目元数据，并由用户在预览中决定研究项目、阅读状态、优先级和“为什么读”。
