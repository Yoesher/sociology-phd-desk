...
- Additional domain objects such as Variable, Model, Code, and Revision Task; `TheoryMemo` already exists and must not be represented by a second generic memo type.
