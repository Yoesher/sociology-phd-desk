...
| Open pull requests | 1 Draft | Phase 3D documentation-only [PR #16](https://github.com/Yoesher/sociology-phd-desk/pull/16) records a BLOCKED compliance gate; it is maintainer-originated and is not a shipped feature. |
| Merged pull requests | 6 | Maintainer-authored PRs #9, #10, #11, #12, Phase 3C [#14](https://github.com/Yoesher/sociology-phd-desk/pull/14), and Phase 3C documentation-closeout [#15](https://github.com/Yoesher/sociology-phd-desk/pull/15), all squash-merged. |
...
| External contributors | 0 verified | Public commits, all six merged Pull Requests, and the sole open Draft PR are maintainer-originated; no external contributor or external Pull Request is verified. |
