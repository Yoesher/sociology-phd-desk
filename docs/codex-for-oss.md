...
| Open pull requests | 0 | PR #16 is merged; no Theory Pull Request exists yet. |
| Merged pull requests | 7 | Maintainer-authored PRs #9, #10, #11, #12, Phase 3C [#14](https://github.com/Yoesher/sociology-phd-desk/pull/14), Phase 3C documentation-closeout [#15](https://github.com/Yoesher/sociology-phd-desk/pull/15), and Phase 3D documentation-only [#16](https://github.com/Yoesher/sociology-phd-desk/pull/16), all squash-merged. |
...
| External contributors | 0 verified | Public commits and all seven merged Pull Requests are maintainer-originated; no external contributor or external Pull Request is verified. |
