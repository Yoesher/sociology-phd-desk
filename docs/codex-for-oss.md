...
| --- | --- | --- |
| Public repository | [Yoesher/sociology-phd-desk](https://github.com/Yoesher/sociology-phd-desk), public | GitHub API/CLI evidence verified the owner, repository name, public visibility, `main` default branch, and description `社会学博士研究工作站｜A local-first ResearchOps workstation for sociology researchers.`; verified exact `main` after Theory PR #18 is `b8c8c60434b1d88c348f83c5d08f2d19770db78a`. |
...
| Closed issues | 4 | Includes Issues [#7](https://github.com/Yoesher/sociology-phd-desk/issues/7), [#1](https://github.com/Yoesher/sociology-phd-desk/issues/1), Phase 3C [#13](https://github.com/Yoesher/sociology-phd-desk/issues/13), and Phase 3D [#8](https://github.com/Yoesher/sociology-phd-desk/issues/8), closed with reason `not planned`. |
| Open pull requests | 0 | PR #18 is merged; the local navigation candidate has not opened a Pull Request. |
| Merged pull requests | 8 | Maintainer-authored PRs #9, #10, #11, #12, Phase 3C [#14](https://github.com/Yoesher/sociology-phd-desk/pull/14), Phase 3C documentation-closeout [#15](https://github.com/Yoesher/sociology-phd-desk/pull/15), Phase 3D documentation-only [#16](https://github.com/Yoesher/sociology-phd-desk/pull/16), and Theory [#18](https://github.com/Yoesher/sociology-phd-desk/pull/18), all squash-merged. |
...
| External contributors | 0 verified | Public commits and all eight merged Pull Requests are maintainer-originated; no external contributor or external Pull Request is verified. |
...
No real external user or tester is verified as of 2026-08-11; the actual number is unknown. The single Star is not user or tester evidence.
...
As of 2026-08-12, verified activity consists of the Phase 0 audit; a durable public `main` history for the Phase 1 application, data-integrity hardening, documentation, Pages infrastructure, merged Phase 3A bilingual implementation, merged Phase 3B research-graph foundation, merged Phase 3C private local workspaces, the merged documentation-only Phase 3D map deferral, and merged Phase 3E Theory Research; passing remote CI; a deployed browser-local demo; and eight maintainer-authored merged Pull Requests. The navigation implementation remains a local candidate and is not public activity or deployment evidence.
