...
- [ ] Open the Theory Pull Request only after the local gate passes; complete exact-head CI, maintainer P0/P1 review, merge, exact-`main` CI, Pages, and public verification before any navigation work begins.
