...
## P0 — Phase 3C Private Local Workspace (local candidate; remote gates pending)
...
- [ ] Open a scoped Pull Request that closes Issue #13, pass exact-head CI, complete maintainer self-review with P0/P1 findings resolved, squash-merge, then pass exact-`main` CI and Pages verification. These remote steps remain pending.
- [ ] Update the verified handoff and public evidence only after those gates complete. Until then, Phase 3C is an unmerged candidate and Phase 3D remains blocked.
